Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://nexol.org/bin/nexolcore-0.13.2/>
...
- #8908 `4a974b2` Update nexol-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow nexol-tx to create v2 transactions (btcdrak)
