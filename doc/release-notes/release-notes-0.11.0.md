Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://nexol.org/bin/nexolcore-0.11.0/>
...
For example, add the following to `nexol.conf`:
...
related to the blockchain in the nexol system: the raw blocks as received over 
...
For an example script see [nexol-submittx](https://github.com/laanwj/nexol-submittx).
...
- #5334 `cf87536` libnexolconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new nexol-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add nexol logo to about screen
...
- #5809 `46bfbe7` Add nexol-cli man page
...
- #5849 `41259ca` contrib/init/nexold.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for nexol-tx)
