Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/nexol/files/Bitcoin/nexol-0.7.0/

We recommend that everybody running prior versions of nexold/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/nexolcore/nexol/tarball/v0.7.0  # .tar.gz
  https://github.com/nexolcore/nexol/zipball/v0.7.0  # .zip
...
Core nexol handling and blockchain database
...
* Ensure a changed nexol unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for nexol-qt.exe
* (Windows only): add meta-data to nexol-qt.exe (e.g. description)
...
* Bash programmable completion for nexold(1)
