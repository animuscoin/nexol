Bitcoin Core version 0.11.1 is now available from:
  ...
  <https://nexol.org/bin/nexolcore-0.11.1/>
...
(see https://github.com/nexolcore/nexol/pull/6795).
...
one was randomly violated by all deployed nexol software prior to
...
http://fc15.ifca.ai/preproceedings/nexol/paper_9.pdf
...
(see https://github.com/nexolcore/nexol/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libnexolconsensus: avoid a crash in multi-threaded environments
