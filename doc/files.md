...
* nexol.conf: contains configuration settings for nexold or nexol-qt
* nexold.pid: stores the process id of nexold while running
...
* debug.log: contains debug information and general logging generated by nexold or nexol-qt
