    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Nexol Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 ##3AB289, stop: 1 #2D916F); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nexol address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nexol: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Nexol Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nexol Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nexol Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nexol addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nexol addresses"));
    ...
    openAction->setStatusTip(tr("Open a nexol: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nexol Core help message to get a list with possible Nexol Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Nexol Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nexol network", "", count));
}
...
{
    QString strTitle = tr("Nexol Core"); // default title
