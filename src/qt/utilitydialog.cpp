    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Nexol Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Nexol Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  nexol-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Nexol in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NXL, 0.1 NXL, 1 NXL and 10 NXL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nexolcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://nexolcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Nexol Core is shutting down...") + "<br /><br />" +
