    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NXL-light"), QVariant("light"));
    ui->theme->addItem(QString("NXL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NXL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NXL-traditional"), QVariant("trad"));
