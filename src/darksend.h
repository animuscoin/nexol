...
static const int MIN_PRIVATESEND_PEER_PROTO_VERSION = 130101;
...
{
public:
    /// Is the input associated with this public key? (and there is 1000 NXL - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of nexol.
