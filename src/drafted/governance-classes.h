 ...
 *
 *   // network
 *   CNexolNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.nexolcore.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNexolNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: NexolNetwork
// //   -- signature requirements : Key1(User)
// class CNexolNetworkVariable : public CGovernanceObject
// {
// private:
