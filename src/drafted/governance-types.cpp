...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NexolNetwork") type = NexolNetwork;
    if(strType == "NexolNetworkVariable") type = NexolNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NexolNetwork) s = "NexolNetwork";
    if(type == NexolNetworkVariable) s = "NexolNetworkVariable";
