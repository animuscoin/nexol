...
2. run nexold with -printalert or -sendalert like this:
   /path/to/nexold -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.nexolcore.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Nexol Core:0.12.0.58/"));
